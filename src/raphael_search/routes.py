...
_db = Path(os.environ.get("RAPHAEL_SEARCH_DB", "/tmp/raphael-search.db"))
...
def list_items() -> dict[str, Any]:
    ...
    return {"service": "raphael-search", "items": [{"id": r[0], "name": r[1], "body": r[2], "created_at": r[3]} for r in rows]}
